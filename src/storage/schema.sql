...
CREATE TABLE IF NOT EXISTS processed_events (event_id TEXT PRIMARY KEY, platform TEXT NOT NULL, group_id TEXT, status TEXT NOT NULL DEFAULT 'completed', attempt_count INTEGER NOT NULL DEFAULT 1, lease_until REAL, last_error TEXT, processed_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);
